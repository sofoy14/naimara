...
describe('preserveWhitespace', function () {
    ...
    it('preserves new lines', function () {
        var options = {
            preserveWhitespace: true,
        };
        var document = {
...
describe('stripEmptyTrailingParagraph', function () {
    it('strips empty trailing paragraph when enabled', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
        ...
        var result = (0, __1.documentToReactComponents)(document, options);
        expect(result).toMatchSnapshot();
    });
    it('does not strip empty trailing paragraph when disabled', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
    ...
    it('does not strip trailing paragraph with multiple text nodes', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
    ...
    it('does not strip trailing non-paragraph node', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
                ...
                {
                    nodeType: rich_text_types_1.BLOCKS.HEADING_1,
                    data: {},
                    content: [
                        {
                            nodeType: 'text',
