...
var defaultNodeRenderers = (_a = {},
    ...
    _a[rich_text_types_1.INLINES.EMBEDDED_RESOURCE] = function (node, _children) {
...
function documentToReactComponents(richTextDocument, options) {
    ...
    if (options.stripEmptyTrailingParagraph) {
        processedDocument = rich_text_types_1.helpers.stripEmptyTrailingParagraphFromDocument(richTextDocument);
    }
    return (0, nodeListToReactComponents_1.nodeToReactComponent)(processedDocument, {
